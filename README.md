...
3. `kubectl apply -f deployment/redpanda.yaml` - Set up the redpanda broker service
4. `kubectl apply -f deployment/udaconnect-connections-consumer.yaml` - Set up the service and deployment for the connections kafka consumer
5. `kubectl apply -f deployment/udaconnect-connections.yaml` - Set up the service and deployment for connections service
4. `kubectl apply -f deployment/udaconnect-location.yaml` - Set up the service and deployment for location service   
4. `kubectl apply -f deployment/udaconnect-person.yaml` - Set up the service and deployment for person service   
