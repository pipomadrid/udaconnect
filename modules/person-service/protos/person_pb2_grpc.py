...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in person_pb2_grpc.py depends on'
...
class PersonServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPerson = channel.unary_unary(
                ...
                response_deserializer=person__pb2.PersonReply.FromString,
...
def add_PersonServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetPerson': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=person__pb2.PersonReply.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('person.PersonService', rpc_method_handlers)
...
class PersonService(object):
    ...
    def GetPerson(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            person__pb2.PersonReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
